...
LANGUAGE_CODE = "zh"
LANGUAGE_NAME = "Chinese" # <-- Please translate, this should be the word "Chinese" in Chinese
LANGUAGE_NAME_ENGLISH = "Chinese"
TRANSLATOR_NAMES = ["mickeywaley"]

#buttons
BTN_CANCEL = "取消"
BTN_OK = "Ok"             # <-- Please translate
BTN_SAVE_AS = "另存为..."
BTN_CLOSE = "关闭"
...
ST_AVAILABLE = "可用的"
ST_AWAY = "离去"
ST_EXTENDED_AWAY = "扩展的距离"
ST_OFFLINE = "离线"

#TaskbarMenu
MTB_SHOW_HIDE_TORCHAT = "显示/隐藏TorChat"
MTB_QUIT = "退出"

#popup menu
MPOP_CHAT = "聊天..."
MPOP_SEND_FILE = "发送文件..."
MPOP_EDIT_CONTACT = "编辑联络..."
MPOP_DELETE_CONTACT = "删除联系人..."
MPOP_SHOW_OFFLINE_MESSAGES = "查看离线消息队列"
MPOP_CLEAR_OFFLINE_MESSAGES = "清除排队离线消息"
...
MPOP_ADD_CONTACT = "新增联络人..."
MPOP_ABOUT = "关于TorChat"
MPOP_TIPJAR = "TorChat Bitcoin Tip-Jar"
MPOP_ASK_AUTHOR = "询问 %s..."
MPOP_SETTINGS = "设置..."
...
D_CONFIRM_DELETE_TITLE = "确认删除"
D_CONFIRM_DELETE_MESSAGE = "确实要删除此联络？\n(%s %s)"

#warning about log
D_LOG_WARNING_TITLE = "TorChat: 日志记录是积极的"
D_LOG_WARNING_MESSAGE = "记录到的文件被激活！\n\nLog File: %s\n\n请记住，删除日志文件如果您已经完成调试，因为日志文件可能包含敏感信息。"

#warning about used port
D_WARN_USED_PORT_TITLE = "TorChat: 端口已在使用中"
D_WARN_USED_PORT_MESSAGE = "Something, 可能还有TorChat例如，已经在听 %s:%s. 您必须创建一个配置文件使用不同的端口，能够启动TorChat第二次。"

# #warning about unread messages
D_WARN_UNREAD_TITLE = "TorChat: 未读消息"
D_WARN_UNREAD_MESSAGE = "有未读消息.\n他们将永远失去！\n\n你真的要退出TorChat呢？"

#warning about offline buddy
D_WARN_BUDDY_OFFLINE_TITLE = "TorChat: 好友离线"
D_WARN_BUDDY_OFFLINE_MESSAGE = "此操作是不可能的离线好友"

#warning about multiple files
D_WARN_FILE_ONLY_ONE_TITLE = "TorChat: 多个文件"
D_WARN_FILE_ONLY_ONE_MESSAGE = "您可能无法启动一个操作多个文件传输。开始转让单独或发送一个zip文件，而不是"

#warning about file save error
D_WARN_FILE_SAVE_ERROR_TITLE = "TorChat: 错误保存文件"
D_WARN_FILE_SAVE_ERROR_MESSAGE = "该文件 '%s' 不能创建.\n\n%s"

#warning about file already exists
D_WARN_FILE_ALREADY_EXISTS_TITLE = "TorChat: 文件存在"
D_WARN_FILE_ALREADY_EXISTS_MESSAGE = "该文件 '%s' 已存在.\n覆盖它?"

#dialog: add/edit contact
DEC_TITLE_ADD = "添加新的联系人"
DEC_TITLE_EDIT = "编辑联络人"
DEC_TORCHAT_ID = "TorChat ID"
DEC_DISPLAY_NAME = "显示名称"
DEC_INTRODUCTION = "导言"
DEC_MSG_16_CHARACTERS = "该地址必须是16个字符长, 不 %i. or 56"
DEC_MSG_ONLY_ALPANUM = "该地址必须只包含数字和小写字母"
DEC_MSG_ALREADY_ON_LIST = "%s 已在您的名单"
...
DFT_FILE_OPEN_TITLE = "发送文件 %s"
DFT_FILE_SAVE_TITLE = "从保存文件 %s"
DFT_SEND = "发送 %s\nto %s\n%04.1f%% (%i of %i bytes)"
DFT_RECEIVE = "接收 %s\nfrom %s\n%04.1f%% (%i of %i bytes)"
...
#settings dialaog
DSET_TITLE = "TorChat配置"
DSET_NET_TITLE = "网络"
DSET_NET_ACTIVE = "活跃"
DSET_NET_INACTIVE = "无效"
DSET_NET_TOR_ADDRESS = "Tor的代理地址"
DSET_NET_TOR_SOCKS = "Socks 端口"
DSET_NET_TOR_CONTROL = "控制端口"
DSET_NET_OWN_HOSTNAME = "自己的 TorChat-ID"
DSET_NET_LISTEN_INTERFACE = "听接口"
DSET_NET_LISTEN_PORT = "监听端口"
DSET_GUI_TITLE = "用户界面"
DSET_GUI_LANGUAGE = "语言"
DSET_GUI_OPEN_MAIN_HIDDEN = "首先，最小化主窗口"
DSET_GUI_OPEN_CHAT_HIDDEN = "不要自动打开新窗"
DSET_GUI_NOTIFICATION_POPUP = "通知弹出"
# DSET_GUI_NOTIFICATION_METHOD = u"Notification method"
DSET_GUI_FLASH_WINDOW = "闪光的新消息窗口的标题"
DSET_MISC_TITLE = "临时目录"
DSET_MISC_TEMP_IN_DATA = "内部数据存储临时文件的目录"
DSET_MISC_TEMP_CUSTOM_DIR = "临时目录（保留为空操作系统默认）"

#notices in the chat window (those in square brackets)
NOTICE_DELAYED_MSG_WAITING = "轮候时间将邮件发送"
NOTICE_DELAYED_MSG_SENT = "拖延已发送的邮件"
NOTICE_DELAYED = "延迟"

#messagebox for offline messages
MSG_OFFLINE_TITLE = "TorChat：排队的消息"
MSG_OFFLINE_EMPTY = "没有（更多）排队的消息的 %s"
MSG_OFFLINE_QUEUED = "排队离线消息 %s:\n\n%s"
